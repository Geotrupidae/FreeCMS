...
<!-- 			<div class="lg_title"><b class="txt">竹云科技管理员登录</b></div> -->
...
window.location.href="http://auth.idscloud.bamboocloud.com/idp/oauth2/authorize?client_id="
	+"freecms2&response_type=code&redirect_uri=http://localhost:8080/FreeCMS/login_oauth.do&state=1231";
