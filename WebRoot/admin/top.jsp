...
var redirectToLogin="${redirectToLogin}";
var logoutUrl="${oauthLogoutUrl}";

function logout(){
	top.location.href=logoutUrl+"?entityId="+clientId+"&redirectToLogin="
			+redirectToLogin+"&redirctToUrl="+redirectUrl;
}
</script>
</HEAD>
...
<TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
  <TBODY>
	<TR>
	  ...
	  <TD colspan="2" style="PADDING-RIGHT: 10px; MARGIN-TOP: 0px; line-height:28px; height:28px; text-align:right;">&nbsp;您好:${loginAdmin.name }，欢迎使用 FreeCMS 1.5 &nbsp;&nbsp;&nbsp;
	...
	<s:property value="name"/></a>|
      ...
      <a href="javascript:void(0)" target="_top" onclick="logout()">退出</a>     
<!--       <a href="../login_out.do" target="_top">退出</a> -->
      </div>
      </TD>
	</TR>
	<TR>
