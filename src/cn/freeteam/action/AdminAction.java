...
public class AdminAction extends BaseAction{
	...
	public String top(){
		...
		clientId = PropertiesUtil.getConfig(propertiesFilePath, "clientId");
		redirectUrl = PropertiesUtil.getConfig(propertiesFilePath, "redirectUrl");
		redirectToLogin = PropertiesUtil.getConfig(propertiesFilePath, "redirectToLogin");
		oauthLogoutUrl = PropertiesUtil.getConfig(propertiesFilePath, "httpLogoutUrl");
		return "top";
	}
	/**
	 * 右侧
	...
	public void setRedirectToLogin(String redirectToLogin) {
